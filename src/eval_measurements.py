...
axs[0].plot(cropped_data_Luft_freq / 1e6, cropped_data_Luft, color = AIR_COLOR )
...
axs[1].plot(cropped_data_AL_Floating_freq / 1e6, cropped_data_AL_Floating, color = AL_FLOATING_COLOR )
...
axs[2].plot(cropped_data_AL_Erdung_freq / 1e6, cropped_data_AL_Erdung, color = AL_GROUNDED_COLOR )
...
axs[3].plot(cropped_data_em_absorber_freq / 1e6, cropped_data_em_absorber, color = EM_ABSORBER_COLOR)
...
axs[4].plot(cropped_data_em_absorber_grounded_freq / 1e6, cropped_data_em_absorber_grounded, color = EM_ABSORBER_GROUNDED_COLOR )
axs[4].axhline(avg_cropped_em_absorber_grounded, color="black", label="AVG ")
axs[4].axhline(mean_cropped_em_absorber_grounded, color="gray", label="MEAN ")
